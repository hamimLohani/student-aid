...
export default function ActivitiesPage() {
  ...
  return (
    <div className="pt-20 sm:pt-24 pb-16 px-3 sm:px-4 max-w-6xl mx-auto">
      <h1 className="text-3xl sm:text-4xl font-bold mb-1">Activities</h1>
      <p className="text-secondary text-sm sm:text-base mb-8 sm:mb-10">Upcoming and past events from Student Aid BDG.</p>
      {activities.length === 0 && <p className="text-muted text-center py-20">No activities yet. Check back soon!</p>}
              ...
              <div className="p-4 sm:p-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-indigo-500 text-xs flex items-center gap-1 group-hover:gap-2 transition-all">View <ArrowRight size={12} /></span>
                  </div>
                </div>
              </div>
            </Link>
